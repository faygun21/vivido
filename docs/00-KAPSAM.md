...
> geçmesi planlanmıyor. [K-18](02-KARARLAR.md#k-18) kararıyla anchor sırası
...
| **I5** | Anchor sırası değişince skor değişmeli — aynı kalmamalı ⚠️ *(şu an sağlanmıyor, bkz. W4 notu / [K-18](02-KARARLAR.md#k-18))* |
